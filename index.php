    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: SRJ Farm Nursery.<br>
            A/P Bharat Galli, Sangola.
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:9028589291">9028589291</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:sandipkhandare10@gmail.com" class="email__addr">sandipkhandare10@gmail.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> farm Nursery Website-PHP&trade;
          </div>

          <div class="developer">
            Developed by Sandeep Khandare and Jalinder Chaure
          </div>

          <div class="designby">
            Design by Rushikesh Lawand and 
                      Swaraj Kale
          </div>
